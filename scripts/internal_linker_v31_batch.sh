#!/usr/bin/env bash
# Batch-loop driver for Semantic Internal Linker v3.1.
...
# Sends a compact run summary to the n8n webhook after the final batch.
#
# Usage:
#   bash internal_linker_v31_batch.sh [--size N] [--max-runs N] [--dry-run] [--export-diffs] [--notify URL]
#
